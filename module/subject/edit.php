                    ...
                    <div class="card-body">
                        <form action="?m=subject&s=update" method="post">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="hour" class="form-control" value="<?= $row['hours'] ?>" placeholder="Jam Mata Pelajaran*" maxlength="2" required>
                            </div>
                            <div class="input-group mb-3">
                                    <input type="submit" name="update" class="btn btn-md btn-primary" value="Simpan">&nbsp;&nbsp;&nbsp;
