                    ...
                    <div class="card-body">
                        <form action="?m=teacher&s=update" method="post" enctype="multipart/form-data">
                            <div class="input-group mb-3">
                                ...
                                <input type="number" name="nip" class="form-control" placeholder="Nomor Induk Guru (Max 16 Digit)" value="<?= $r['nip'] ?>"  required autofocus>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="phone" class="form-control" placeholder="Nomor Handphone" value="<?= $r['phone'] ?>">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                &nbsp;&nbsp;
                                <img src="assets/imgs/teachers/small_<?= $r['photo'] ?> " alt="Tanpa Foto" height="74px">
                                &nbsp;&nbsp;&nbsp;
                                <small for="">Klik Untuk Mengganti Foto >></small>
                                &nbsp;&nbsp;&nbsp;
                                <input type="file" accept=".jpg" name="foto" class="form-control" placeholder="Foto Guru" value="<?= $r['photo'] ?>">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
